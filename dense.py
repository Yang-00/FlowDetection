...
if(not os.path.isdir("train")):
        z = zipfile.ZipFile("D:/Shixun/dataSet/train.zip", 'r')
        z.extractall("")
        z.close()

start = time.time()
#把图片对应的标签装入字典
f = open('D:/Shixun/dataSet/train.json')
content = json.load(f)
...
print(content['annotations'][1]['name'])
#读取解压文件里的信息
zfile = zipfile.ZipFile("D:/Shixun/dataSet/train.zip")
l = []
...
name = 'D:/Shixun/dataSet/train/8538edb45aaf7df78336aa5b49001be6.jpg'
imm = Image.open(name)
print(imm.size)
...
def train_set():
    def inner():
        for ig_index in range(2000):  # 遍历所有图片
            ...
            if content['annotations'][ig_index]['name'] == 'D:/Shixun/dataSet/train/8538edb45aaf7df78336aa5b49001be6.jpg': continue
            if content['annotations'][ig_index]['name'] == 'D:/Shixun/dataSet/train/377df0a7a9abc44e840e938521df3b54.jpg': continue
...
if (not os.path.isdir("test")):
    z = zipfile.ZipFile("D:/Shixun/dataSet/test.zip", 'r')
    z.extractall("")
    z.close()
# 测试图片
import numpy as np
...
test_zfile = zipfile.ZipFile("D:/Shixun/dataSet/test.zip")
l_test = []
